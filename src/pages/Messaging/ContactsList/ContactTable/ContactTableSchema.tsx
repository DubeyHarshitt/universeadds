...
import RecentOrdersTable from './ContactTableStruct';
import { subDays } from 'date-fns';
import { useQuery } from 'react-query';
// import { useGetGroup } from 'src/services/fetchGroups';
...
function ContactTableShema() {
  // const contactGroup: ContactGroups[] = [
  //   { id: "1", groupName: "Group A", owner: 98 },
  //   { id: "2", groupName: "Group B", owner: '299 }
  // ]

  // const { data, isLoading, error } = useGetGroup('11');
  // console.log(data);

  // const cryptoOrders: CryptoOrder[] = [
  //   { id: '3', owner: '11', groupName: 'New group 111', status: 'completed' }
  //   // {
  //   //   id: '2',
  ...
  return (
    <Card>
      {/* <RecentOrdersTable cryptoOrders={data} data={data} /> */}
    </Card>
  );
}

export default ContactTableShema;
